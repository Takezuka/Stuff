...
.text-button.filled:not(.disabled):hover::after {
  background-color: rgba(var(--state-layers-on-primary), var(--opacity-state-layers-008));
}

.text-button.filled:not(.disabled):active::after {
  background-color: rgba(var(--state-layers-on-primary), var(--opacity-state-layers-012));
}
